...
invalid_musig_nonce_ser_length = [
    65 * b"\x01",
    67 * b"\x01",
]

invalid_musig_nonce_length = [
    ctypes.create_string_buffer(131),
    ctypes.create_string_buffer(133),
]

invalid_musig_part_sig_length = [
    ctypes.create_string_buffer(31),
    ctypes.create_string_buffer(33),
]

invalid_musig_keyagg_cache_lenght = [
    ctypes.create_string_buffer(196),
    ctypes.create_string_buffer(198),
]

invalid_musig_session_length = [
    ctypes.create_string_buffer(132),
    ctypes.create_string_buffer(134),
]
...
valid_pubnonce_serializations = [
    b'\x03\x1a\x8fN\xe4U\xf7\xda\xf8\x8c^\xb4\x06x\xa8\xa5\xf7\r*\xb0\x9b\x7f\x13u\xd5\xc8\x97T08\xae\xb3E\x02\xef$\xdbI\xf5\x9a\xbe \xa1#\xe4\xefo\xceb\xb4\xe5-]\xc1\x92\x15\x95\xd0!\xbf\x0bK\xee.\x10\xab',
    b'\x03Yq-a\xb2\xcf\xd1\x95\xa3n\x92Z]<J\xd3\xff\xd8h\x01\xacR\xectG\x7fz\xfbc1v\xc1\x03\x0e?\xb5\xfd1(\xea\xb9I\xd5\xd8\xb3\x16\xad?\xf0\xd4kw> Z\xe0\xcd\xa2\x80D\xf6\xad\xedv\x1b'
]
